...
object FlatteningMap {
    ...
    fun fromFlatName(flatName: String): String {
        return reverseMap[flatName] ?: flatName
    }

    private var normalMap:Map<String, String>
    private var reverseMap:Map<String, String>
    init {
        val map = """
            ...
            firework_star_overlay fireworks_charge_overlay
            tropical_fish fish_clownfish_raw
            cooked_cod fish_cod_cooked
            cod fish_cod_raw
            ...
            end_portal_frame_eye endframe_eye
            end_portal_frame_side endframe_side
            end_portal_frame_top endframe_top
            ...
            item_frame itemframe_background
            ...
            slime_block slime
            smooth_andesite stone_andesite_smooth
            smooth_diorite stone_diorite_smooth
            smooth_granite stone_granite_smooth
            spawner mob_spawner
        ...
        val afterFlattening = map.lines().map { it.substringBefore(" ") }
        val beforeFlattening = map.lines().map { it.substringAfter(" ") }

        normalMap = beforeFlattening.zip(afterFlattening).toMap()
        reverseMap = afterFlattening.zip(beforeFlattening).toMap()
    }
}